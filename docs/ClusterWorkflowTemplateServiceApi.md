...
> ClusterWorkflowTemplate clusterWorkflowTemplateServiceCreateClusterWorkflowTemplate(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClusterWorkflowTemplate result = apiInstance.clusterWorkflowTemplateServiceCreateClusterWorkflowTemplate(body);
...
> ClusterWorkflowTemplate clusterWorkflowTemplateServiceGetClusterWorkflowTemplate(name, getOptionsResourceVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClusterWorkflowTemplate result = apiInstance.clusterWorkflowTemplateServiceGetClusterWorkflowTemplate(name, getOptionsResourceVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
> ClusterWorkflowTemplate clusterWorkflowTemplateServiceLintClusterWorkflowTemplate(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    ClusterWorkflowTemplateServiceApi apiInstance = new ClusterWorkflowTemplateServiceApi(defaultClient);
    ClusterWorkflowTemplateLintRequest body = new ClusterWorkflowTemplateLintRequest(); // ClusterWorkflowTemplateLintRequest | 
    try {
      ClusterWorkflowTemplate result = apiInstance.clusterWorkflowTemplateServiceLintClusterWorkflowTemplate(body);
      System.out.println(result);
    } catch (ApiException e) {
...
> ClusterWorkflowTemplateList clusterWorkflowTemplateServiceListClusterWorkflowTemplates(listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
> ClusterWorkflowTemplate clusterWorkflowTemplateServiceUpdateClusterWorkflowTemplate(name, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    ClusterWorkflowTemplateUpdateRequest body = new ClusterWorkflowTemplateUpdateRequest(); // ClusterWorkflowTemplateUpdateRequest | 
    try {
      ClusterWorkflowTemplate result = apiInstance.clusterWorkflowTemplateServiceUpdateClusterWorkflowTemplate(name, body);
      System.out.println(result);
    } catch (ApiException e) {
