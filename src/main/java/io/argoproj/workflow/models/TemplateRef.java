...
public class TemplateRef {
  ...
  **/
  ...
  public TemplateRef runtimeResolution(Boolean runtimeResolution) {
   ...
   /**
   * RuntimeResolution skips validation at creation time. By enabling this option, you can create the referred workflow template before the actual runtime. DEPRECATED: This value is not used anymore and is ignored
   * @return runtimeResolution
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "RuntimeResolution skips validation at creation time. By enabling this option, you can create the referred workflow template before the actual runtime. DEPRECATED: This value is not used anymore and is ignored")
