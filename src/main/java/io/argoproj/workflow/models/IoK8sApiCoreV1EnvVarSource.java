...
public class IoK8sApiCoreV1EnvVarSource {
  ...
  public IoK8sApiCoreV1EnvVarSource configMapKeyRef(io.kubernetes.client.models.V1ConfigMapKeySelector configMapKeyRef) {
  ...
  **/
  ...
  public IoK8sApiCoreV1EnvVarSource secretKeyRef(io.kubernetes.client.models.V1SecretKeySelector secretKeyRef) {
