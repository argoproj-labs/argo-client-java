...
public class Prometheus {
  ...
  **/
   ...
   * @return labels
  **/
  @ApiModelProperty(required = true, value = "Labels is a list of metric labels")
  ...
  **/
   ...
   * @return when
  **/
  @ApiModelProperty(required = true, value = "When is a conditional statement that decides when to emit the metric")
